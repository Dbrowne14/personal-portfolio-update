...
export default function RootLayout({
  ...
  return (
    <html
      ...
      // The theme script below intentionally sets data-theme on this
      // element before hydration, which the server-rendered HTML never
      // has — the standard theme-flash-prevention pattern. This is the
      // expected mismatch that prop exists for.
